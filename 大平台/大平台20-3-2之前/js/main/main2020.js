...
let alertIframe = (event, width = '100%')=>{
    ...
    let iframeHtml = $(`<div class="iframe" id="${f_id}">
                            <div class="iframe-header" style="width: ${width}">
                                ...
                                <div class="iframe-header-fun">
                                    <span class="iframe-fun iframe-back"></span>
                                    <span class="iframe-fun iframe-minus"></span>
                                    <span class="iframe-fun iframe-close"></span>
                                </div>
                            </div>
    ...
    iframeHtml.on('click','.iframe-minus',showIframe);
    // 点击关闭按钮 关闭弹框
    footerListHtml.on('click','.delete',showList);
    // 点击iframe关闭按钮 关闭弹框
    iframeHtml.on('click','.iframe-close',showList);
...
/** 应用区悬浮跑马灯效果 **/
let pmd = ()=>{
    $('.cyyy-yy').hover(function(){
            $(this).append(`<div class='leftToRight'></div>
                            <div class='topToBottom'></div>
                            <div class='rightToLeft'></div>
                            <div class='bottomToTop'></div>`);
        // $(".leftToRight").addClass('show');
        // $(".topToBottom").addClass('show');
        // $(".rightToLeft").addClass('show');
        // $(".bottomToTop").addClass('show');
    },function () {
        // $(".leftToRight").removeClass('show');
        // $(".topToBottom").removeClass('show');
        // $(".rightToLeft").removeClass('show');
